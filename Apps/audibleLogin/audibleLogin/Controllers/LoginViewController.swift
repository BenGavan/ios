...
class LoginViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, LoginControllerDelegate {
    ...
    let pages: [Page] = {
        let firstPage = Page(title: "Share a great listen", message: "It's free to send your books to the people in your life, Every revipient's first book is on us", imageName: "page1")
        
        let secondPage = Page(title: "Send from your library", message: "Tap the more menue next to any book. coose... send this book", imageName: "page2")
        
        let thirdPage = Page(title: "Send from the player", message: "Tap the more menue next to any book. coose... send this book", imageName: "page3")
...
//            loginCell.loginController = self
    ...
    func finishLoggingIn() {
        ...
        mainNavivationController.viewControllers = [HomeViewController()]
    ...
    override func willTransition(to newCollection: UITraitCollection, with coordinator: UIViewControllerTransitionCoordinator) {
        ...
        //scroll to indexpath after totation is going 
